...
#define LED0_GPIO_PORT    	GPIOG		              /* GPIO端口 */
#define LED0_GPIO_CLK 	    RCC_APB2Periph_GPIOG		/* GPIO端口时钟 */
#define LED0_GPIO_PIN		GPIO_Pin_13

#define LED1_GPIO_PORT    	GPIOG		              /* GPIO端口 */
#define LED1_GPIO_CLK 	    RCC_APB2Periph_GPIOG		/* GPIO端口时钟 */
#define LED1_GPIO_PIN		GPIO_Pin_14

#define LED2_GPIO_PORT    	GPIOG			              /* GPIO端口 */
#define LED2_GPIO_CLK 	    RCC_APB2Periph_GPIOG		/* GPIO端口时钟 */
